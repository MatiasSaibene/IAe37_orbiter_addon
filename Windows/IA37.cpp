...
void IA37::clbkSetClassCaps(FILEHANDLE cfg){
	...
	CreateAirfoil3 (LIFT_HORIZONTAL, _V(0,0,-4), HLiftCoeff, 0, IA37_HLIFT_C, IA37_HLIFT_S, IA37_HLIFT_A);
...
int IA37::clbkConsumeBufferedKey(DWORD key, bool down, char *kstate){
